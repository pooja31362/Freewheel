"""
Django settings for Support_Portal project.
...
SECRET_KEY = 'django-insecure-0gmol1e&po1@9%pgo8t5!(pkb19vf&4w@8-2x($&)j#ivvp-mf'
...
INSTALLED_APPS = [
    'Freewheel_Portal.apps.PortalAppConfig',
